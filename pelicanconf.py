...
AUTHOR          = 'Aline Jenita'  # use your name
SITENAME        = 'pynotes' # use title
GITHUB_USERNAME = 'alinejenita' # use your username
...
# Social widget
SOCIAL = (
    ("GitHub", "https://github.com/alinejenita/"),
    ("LinkedIn", "https://www.linkedin.com/in/aline-jenita/"),
)
